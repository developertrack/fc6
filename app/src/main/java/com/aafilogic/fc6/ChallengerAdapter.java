...
public class ChallengerAdapter extends RecyclerView.Adapter<ChallengerAdapter.ViewHolder> {

    public List<PersonUtils> personUtils;
    private Context context;

    public ChallengerAdapter(Context context, List personUtils) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.challenger_layout, parent, false);
