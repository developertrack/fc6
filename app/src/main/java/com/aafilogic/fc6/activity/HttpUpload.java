...
import com.aafilogic.fc6.activity.MyMultipartEntity.ProgressListener;
...
//	private static final String url = "http://localhost:3000/upload";
	...
	protected Void doInBackground(Void... params) {
		try {
			...
			// 填充字段
	        entity.addPart("count", new StringBody("1", Charset.forName("UTF-8")));
