...
public class badgesAdapterMenu extends RecyclerView.Adapter<badgesAdapterMenu.MyViewHolder> {


    private List<badgesDto> badgesDetails;
    private Context context;

    public badgesAdapterMenu(List<badgesDto> badgesDetails, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.badgesadapter_menu, viewGroup, false);
