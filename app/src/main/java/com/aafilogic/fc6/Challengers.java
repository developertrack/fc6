...
public class Challengers extends AppCompatActivity {
    private static final String TAG_T = "Challengers Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            recyclerView2 = (RecyclerView) findViewById(R.id.teamlistrecyclerview5);
            ...
            String url = "https://www.aafilogicinfotech.com/demo/FC6/api/get_challenger_ranking.php";
            ...
            StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        mAdapter2 = new ChallengerAdapter(getApplicationContext(), personUtilsList2);
