...
public class TeamMemberAdapter extends RecyclerView.Adapter<TeamMemberAdapter.ViewHolder> {
    ...
    public TeamMemberAdapter(Context context, List personUtils) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.teamlistdetail22, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        try {
            ...
            Picasso.with(context).load("https://www.aafilogicinfotech.com/demo/FC6/api/" + pu.getUser_image()).placeholder( R.drawable.progress_animation ).into(holder.user_image);
            ...
            holder.team_points.setText(pu.getTotal_points());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView team_name, user_name, post_time, workouts, meals, team_points, quantity;
        ...
        public ViewHolder(View itemView) {
            ...
            team_points = (TextView) itemView.findViewById(R.id.team_points);
